 ...
 * @data 2020/7/29
 */
public class OtherCarouselTransformer implements ViewPager.PageTransformer {
    ...
    public OtherCarouselTransformer(@FloatRange(from = 0,to = 1) float scale, float pagerMargin, float spaceValue) {
        this.scale = scale;
