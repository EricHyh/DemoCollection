 ...
 */
public class NativePicasso {

    /**
     * Callbacks for NativePicasso events.
     */
    public interface Listener {
         ...
         */
        void onImageLoadFailed(NativePicasso picasso, Uri uri, Exception exception);
    }
    ...
    static final String TAG = "NativePicasso";
    ...
    static volatile NativePicasso singleton = null;
    ...
    NativePicasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
     ...
     * be used for debugging NativePicasso behavior. Do NOT pass {@code BuildConfig.DEBUG}.
     */
    ...
    /**
     * The global default {@link NativePicasso} instance.
     * <p>
     ...
     * with full control over the configuration by using {@link NativePicasso.Builder} to create a
     * {@link NativePicasso} instance. You can either use this directly or by setting it as the global
     * instance with {@link #setSingletonInstance}.
     */
    public static NativePicasso with(Context context) {
        if (context == null) {
            throw new IllegalArgumentException("context == null");
        }
        if (singleton == null) {
            synchronized (NativePicasso.class) {
                if (singleton == null) {
     ...
     */
    public static void setSingletonInstance(NativePicasso picasso) {
        if (picasso == null) {
            throw new IllegalArgumentException("NativePicasso must not be null.");
        }
        synchronized (NativePicasso.class) {
            if (singleton != null) {
    ...
    /**
     * Fluent API for creating {@link NativePicasso} instances.
     */
    @SuppressWarnings("UnusedDeclaration") // Public API.
    public static class Builder {
        ...
        /**
         * Start building a new {@link NativePicasso} instance.
         */
         ...
         * <p>
         * Note: Calling {@link NativePicasso#shutdown() shutdown()} will not shutdown supplied executors.
         */
        ...
        /**
         * Create the {@link NativePicasso} instance.
         */
        public NativePicasso build() {
            ...
            return new NativePicasso(context, dispatcher, cache, listener, transformer, requestHandlers, stats,
