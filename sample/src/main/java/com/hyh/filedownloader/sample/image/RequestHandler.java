...
/**
 * {@code RequestHandler} allows you to extend NativePicasso to load images in ways that are not
 ...
 * {@link NativePicasso.Builder#addRequestHandler(RequestHandler)}
 * <p>
 * <b>Note:</b> This is a beta feature. The API is subject to change in a backwards incompatible
 * way at any time.
 *
 * @see NativePicasso.Builder#addRequestHandler(RequestHandler)
 */
public abstract class RequestHandler {
    ...
    public static final class Result {
        private final NativePicasso.LoadedFrom loadedFrom;
        private final Bitmap bitmap;
        private final InputStream inputStream;
        private final int exifOrientation;

        public Result(Bitmap bitmap, NativePicasso.LoadedFrom loadedFrom) {
            this(Utils.checkNotNull(bitmap, "bitmap == null"), null, loadedFrom, 0);
        }

        public Result(InputStream inputStream, NativePicasso.LoadedFrom loadedFrom) {
            this(null, Utils.checkNotNull(inputStream, "inputStream == null"), loadedFrom, 0);
        }
        ...
        /**
         * Returns the resulting {@link NativePicasso.LoadedFrom} generated from a
