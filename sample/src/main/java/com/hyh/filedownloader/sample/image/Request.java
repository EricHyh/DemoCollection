...
public final class Request {
     ...
     */
    public final NativePicasso.Priority priority;
    ...
    private Request(Uri uri, int resourceId, String stableKey, List<Transformation> transformations,
                    ...
                    boolean purgeable, Bitmap.Config config, NativePicasso.Priority priority) {
        this.uri = uri;
    ...
    public static final class Builder {
        ...
        private NativePicasso.Priority priority;
         ...
         */
        public Builder priority(NativePicasso.Priority priority) {
            if (priority == null) {
        ...
        public Request build() {
            ...
            if (priority == null) {
                priority = NativePicasso.Priority.NORMAL;
            }
