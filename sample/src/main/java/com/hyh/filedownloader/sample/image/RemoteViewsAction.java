...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
    ...
    RemoteViewsAction(NativePicasso picasso, Request data, RemoteViews remoteViews, int viewId,
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(NativePicasso picasso, Request data, RemoteViews remoteViews, int viewId,
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        NotificationAction(NativePicasso picasso, Request data, RemoteViews remoteViews, int viewId,
