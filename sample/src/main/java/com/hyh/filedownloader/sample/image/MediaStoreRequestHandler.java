    ...
    public Result load(Request request, int networkPolicy) throws IOException {
        ...
        if (request.hasSize()) {
            ...
            if (!isVideo && picassoKind == PicassoKind.FULL) {
                return new Result(null, getInputStream(request), NativePicasso.LoadedFrom.DISK, exifOrientation);
            }
            ...
            if (bitmap != null) {
                return new Result(bitmap, null, NativePicasso.LoadedFrom.DISK, exifOrientation);
            }
        }
        return new Result(null, getInputStream(request), NativePicasso.LoadedFrom.DISK, exifOrientation);
    }
