...
import com.hyh.common.http.HappyHttp;
import com.hyh.common.http.Response;
...
public interface Downloader {
    ...
    Downloader DEFAULT_DOWNLOADER = new Downloader() {
        @Override
        public Response load(Request request) throws IOException {
            return HappyHttp.from(request.uri.toString()).call().execute();
        }
