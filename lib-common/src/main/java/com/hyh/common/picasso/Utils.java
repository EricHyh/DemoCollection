...
final class Utils {
    static final String THREAD_PREFIX = "NativePicasso-";
    ...
    */
    ...
    static void log(String owner, String verb, String logId, String extras) {
        Log.d(NativePicasso.TAG, format("%1$-11s %2$-12s %3$s %4$s", owner, verb, logId, extras));
    }
    ...
    static int calculateMemoryCacheSize(Context context) {
        ...
        int cacheSize = (int) (1024L * 1024L * memoryClass / 7);
