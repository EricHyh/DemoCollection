...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setBackground(this, a.getDrawable(android.support.design.R.styleable.AppBarLayout_android_background));
        if (a.hasValue(android.support.design.R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(android.support.design.R.styleable.AppBarLayout_expanded, false), false, false);
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (a.hasValue(android.support.design.R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                this.setKeyboardNavigationCluster(a.getBoolean(
                        android.support.design.R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(android.support.design.R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                this.setTouchscreenBlocksFocus(a.getBoolean(
                        android.support.design.R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        a.recycle();
