 ...
 * @data 2020/7/13
 */
public class JSWeb2Activity extends Activity {

    public static void start(Context context) {
        Intent intent = new Intent(context, JSWeb2Activity.class);
    ...
    public void test(View view) {
       /* height += 5;
        ...
        mWebView.loadUrl("javascript:removeTags(\"div\",\"news-layout news-wrapper recommend-layout\")");
    }
