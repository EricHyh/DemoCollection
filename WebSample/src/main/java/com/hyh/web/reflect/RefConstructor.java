...
public class RefConstructor<E> extends RefExecutable<E, RefConstructor<E>> {
    ...
    @Override
    public <P> RefConstructor<E> param(Class<P> type, P param) {
    ...
    public E newInstance() {
        ...
        try {
            ...
            this.throwable = new RefException("Constructor: " + getConstructorSignature() + " found in Class[" + cls + "], but newInstance failed", e);
        }
    ...
    public E newInstanceWithException() throws RefException {
