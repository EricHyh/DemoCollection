...
public class OldNestedScrollWebView extends WebView implements NestedScrollingChild2 {
    ...
    public OldNestedScrollWebView(Context context) {
        this(context, null);
    }

    public OldNestedScrollWebView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OldNestedScrollWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class ViewFlingHelper implements Runnable {
        ...
        void postOnAnimation() {
            ...
            ViewCompat.postOnAnimation(OldNestedScrollWebView.this, this);
        }
