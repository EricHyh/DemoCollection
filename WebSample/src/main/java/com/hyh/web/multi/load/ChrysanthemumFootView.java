...
public class ChrysanthemumFootView implements IFootView, View.OnClickListener {
    ...
    private static final String LOAD_FAILURE_TEXT = "暂无更多，刷新试试";
    ...
    private CharSequence mLoadingText = LOADING_TEXT;
    private CharSequence mLoadSuccessText = LOAD_SUCCESS_TEXT;
    private CharSequence mLoadFailureText = LOAD_FAILURE_TEXT;
    private CharSequence mLoadNoMoreText = LOAD_NO_MORE_TEXT;
    ...
    public ChrysanthemumFootView(Context context,
                                 @ColorInt int backgroundColor,
                                 @ColorInt int textColor,
                                 @ColorInt int lineColor) {
        this(context, backgroundColor, textColor, lineColor, false);
    }
    ...
    public ChrysanthemumFootView(Context context,
        ...
        this.mShowRetryBtn = showRetryBtn;
    }
    ...
    public void setLoadSuccessText(CharSequence loadSuccessText) {
        mLoadSuccessText = loadSuccessText;
    }

    public void setLoadFailureText(CharSequence loadFailureText) {
        mLoadFailureText = loadFailureText;
    }

    public void setLoadNoMoreText(CharSequence loadNoMoreText) {
