...
public class FloatingWindow implements FloatingView.WindowEventListener {
    ...
    public void onAttachedToWindow() {
        mChildView.onAttachedToWindow();
    }

    @Override
    public void onDetachedFromWindow() {
        mChildView.onDetachedFromWindow();
    ...
    private Animation getHideAnimation(AnimationStyle style) {
        ...
        switch (style) {
            ...
            case SCALE:
                ...
                break;
            case TRANSLATE:
                animation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT, 0f,
    ...
    private static class ViewOnAttachStateChangeListener implements View.OnAttachStateChangeListener {
        ...
        public ViewOnAttachStateChangeListener(FloatingWindow floatingWindow) {
    ...
    public static class Builder {
        ...
        public Builder view(FloatChildView listener) {
