...
public final class MultiDex {
     ...
     */
    public static void install(Context context, ClassLoader blockClassLoader, String blockPath) {
        ...
        try {
            ...
            doInstallation(context,
                    ...
                    NO_KEY_PREFIX, blockClassLoader);
...
//    }
    ...
    private static void doInstallation(Context mainContext, File sourceApk, File dataDir,
                                       String secondaryFolderName, String prefsKeyPrefix, ClassLoader classLoader) throws IOException,
